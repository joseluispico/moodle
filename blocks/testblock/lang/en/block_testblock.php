...
$string['configallowadditionalcssclasses'] = 'Adds a configuration option to Test Block block instances allowing additional CSS classes to be set.';
...
$string['configtitle'] = 'Test block title';
...
$string['showinstead'] = 'Show courses instead of users';